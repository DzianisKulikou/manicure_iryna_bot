lexicon_dict_en: dict[str, str] = {
    ...
    'price list': '<u><b>Manicure:</b></u>\n\n'
                  '<b>1.</b> Manicure + gel-polish - 30 zl\n'
                  '<b>2.</b> Manicure + gel strengthening - 30 zl\n'
                  '<b>3.</b> Manicure + strengthening with gel + gel-polish - 40 zl\n'
                  '<b>4.</b> Manicure - 20 zl\n'
                  '<b>5.</b> Removal of gel polish/acrylic (uncoated) - 20 zl\n'
                  '<b>6.</b> Nail extensions - 40 zl\n\n'
                  '<u><b>Designs:</b></u>\n\n '
...
lexicon_disinfection_en: dict[str, str] = {
    ...
    'phrase6': '<b>5.</b> Further, for additional disinfection, I use a glasperlen (ball) sterilizer, which is '
               ...
               'heated to a temperature of 175 to 200 °C.',
