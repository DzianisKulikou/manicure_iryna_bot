lexicon_dict_ru: dict[str, str] = {
    ...
    '/help': 'У меня вы можете узнать всё, о работе Ирины Куликовой Мастером по маникюру!\n'
             ...
             'Для управления ботом используйте встроенные клавиатуры внизу экрана. Они будут видоизменяться, при '
             'переходе вами по разным разделам. Так же клавиатуру можно прокручивать вверх и вниз (чтоб увидеть '
             'все возможности), как обычное текстовое окно в телеграмме!\nЕсли у вас возникли вопросы по работе '
             'с ботом, можете зайти в раздел информации о разработчике и задать ему все вопросы напрямую!\n'
             'Приятной вам работы с ботом!)',
    ...
    'price list': '<u><b>Маникюр:</b></u>\n\n'
                  '<b>1.</b> Маникюр + гель-лак - 30 zl\n'
                  '<b>2.</b> Маникюр + укрепление гелем - 30 zl\n'
                  '<b>3.</b> Маникюр + укрепления гелем + гель-лак - 40 zl\n'
                  '<b>4.</b> Маникюр - 20 zl\n'
                  '<b>5.</b> Снятие гель-лака/акрила (без покрытия) - 20 zl\n'
                  '<b>6.</b> Наращивание ногтей - 40 zl\n\n'
                  '<u><b>Дизайны:</b></u>\n\n '
