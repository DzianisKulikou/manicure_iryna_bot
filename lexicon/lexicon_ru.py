lexicon_dict_ru: dict[str, str] = {
    ...
    'developer': 'Данного бота разработал Денис Куликов. Если вы хотите для себя разработать Телеграмм бота, можете '
                 'связаться со мной по телефону: +48789137022. Нажав на кнопку под этим сообщением, вы можете написать '
                 'мне личное сообщение в телеграмме. Я могу разработать для вас бота под ключ!'
}
